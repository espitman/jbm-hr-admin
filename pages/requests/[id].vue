    ...
    <div v-else class="space-y-6">
      <div class="grid grid-cols-4 gap-6">
        ...
        <div class="space-y-6">
          ...
          <!-- Status Update -->
          <div v-if="request.status === 'pending'" class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
              <h2 class="text-lg font-semibold text-gray-700 mb-4">تغییر وضعیت</h2>
        ...
        <div class="col-span-3 space-y-6">
          ...
          <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h2 class="text-lg font-semibold text-gray-700 mb-4">اطلاعات درخواست</h2>
                  <div class="space-y-4">
                    <div>
          ...
          <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
              <h2 class="text-lg font-semibold text-gray-700 mb-4">توضیحات</h2>
              <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-sm text-gray-900 whitespace-pre-line">{{ request.description }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
              <h2 class="text-lg font-semibold text-gray-700 mb-4">تاریخچه وضعیت</h2>
              <div class="space-y-4">
