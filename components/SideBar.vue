<template>
  <div class="bg-white border-l border-gray-200 w-64 fixed top-16 right-0 overflow-y-auto h-[calc(100vh-4rem)]" dir="rtl">
    <div class="p-4">
      <div class="space-y-6">
        <div class="space-y-2">
          <div class="text-xs font-semibold text-gray-400 uppercase">اصلی</div>
        ...
        <div class="space-y-2">
          <div class="text-xs font-semibold text-gray-400 uppercase">کامپوننت‌ها</div>
        ...
        <div class="space-y-2">
          <div class="text-xs font-semibold text-gray-400 uppercase">آیکون‌ها</div>
        ...
        <div class="space-y-2">
          <div class="text-xs font-semibold text-gray-400 uppercase">نقشه‌ها</div>
          <a href="#" class="flex items-center justify-between px-3 py-2 text-gray-600 hover:bg-gray-50 rounded-lg">
            <div class="flex items-center space-x-2">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="space-y-2">
          <div class="text-xs font-semibold text-gray-400 uppercase">صفحات و زیرمنوها</div>
          <a href="#" class="flex items-center justify-between px-3 py-2 text-gray-600 hover:bg-gray-50 rounded-lg">
            <div class="flex items-center space-x-2">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
              </svg>
              <span>صفحات سفارشی</span>
            </div>
            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
